...
module.exports = async function handler(req, res) {
  ...
  try {
    await transporter.sendMail({
      ...
      html: '<div style="background:#080a0e;padding:32px;font-family:sans-serif;max-width:480px;margin:0 auto;border-radius:12px;border:1px solid rgba(255,120,0,0.3)">'
